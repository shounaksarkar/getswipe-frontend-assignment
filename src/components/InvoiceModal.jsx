              ...
              <tbody>
                {props.items.map((item, i) => {
                  ...
                  return (
                    <tr key={i}>
                      <td>
                        {product ? product.name : 'Unknown Product'} - {product ? product.description : ''}
                      </td>
                      <td>{item.itemQuantity}</td>
                      <td>
                        {props.currency} {product ? product.price : 'N/A'}
                      </td>
                      <td className="text-end">
                        {props.currency} {item.itemQuantity * (product ? product.price : 0)}
                      </td>
                    </tr>
                  );
                })}
